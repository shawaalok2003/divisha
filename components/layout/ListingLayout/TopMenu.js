...
export default function TopMenu() {
    ...
    return (
        <header
            className={`main-header header-sticky header-sticky-smart header-style-01 header-float text-uppercase ${isLightThemeMode(router.pathname) ? menuColor : "bg-dark"
                }`}
        >
