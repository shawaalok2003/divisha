...
const InvestorIdentityKYC = (props) => {
    ...
    return (
        <SideModal title={"Identity Information"} {...props}>
            {loader && (
...
export default InvestorIdentityKYC;
